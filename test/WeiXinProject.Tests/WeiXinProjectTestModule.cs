...
using WeiXinProject.Tests.DependencyInjection;
...
namespace WeiXinProject.Tests
{
    ...
    public class WeiXinProjectTestModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            RegisterFakeService<AbpZeroDbMigrator<WeiXinProjectDbContext>>();
